          ...
          <div class="content-top">
            <div class="content-top-L">
              ...
              <div class="content-top-L-3">
                ...
                <div class="content-top-L-3-2">
                  ...
                  {{
                    i.ACTIVITY_REMAINING_PLACES <= 0
                      ? 0
                      : i.ACTIVITY_REMAINING_PLACES
                  }}人)
                </div>
              </div>
            ...
            <div class="content-top-R">
              <div id="btn">
                <!-- 觸發按鈕 -->
                <button
                  @click="confirmRegistration(i.ACTIVITY_ID)"
                        ...
                        <div class="list2-f">
                          <div class="list2">
                            ...
                            <div class="gp-2">
                              ...
                              ><span class="list2-2-2">{{
                                activityData.ACTIVITY_DATE
                              }}</span>
                            </div>
                            <div class="gp-3">
                              <span class="list2-3">報名人數</span
                              ><span class="list2-3-2">{{ quantity }}人</span>
                            </div>
                            <div class="gp-4">
                              <span class="list2-4">總金額</span
                              ><span class="list2-4-2"> ${{ this.total }}</span>
                            </div>
                          </div>
                          <div class="gp-4">
                            <p class="list2-check">
