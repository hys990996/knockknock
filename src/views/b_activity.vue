                ...
                <div class="table-section" :class="{'blurred':isBlurred}">
                    <div class="search-section">
                        ...
                        <div class="search-section-right">
                            <input type="text" placeholder="以活動編號搜尋">
                            <span>搜尋</span>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered ">
                        ...
                        <tbody>
                            <tr v-for="(i, index) in  active" :key="index">
                                ...
                                <td><button @click="showInfo" class="btn btn btn-warning">報名資料</button></td>
                                <td><button @click="show"  class="btn btn btn-warning">編輯</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
